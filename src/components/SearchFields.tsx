...
const SearchFields = (props: SearchFieldsProps) => {
  ...
  return (
    <div className="search flex items-end m-20">
      ...
      <div className="w-full md:w-1/4 px-3 mb-6 md:mb-0">
        <label
          className="block uppercase tracking-wide text-white text-left text-xs font-bold mb-2"
          htmlFor="grid-state"
        >
          State
        </label>
      ...
      <button
        onClick={searchClick}
        className="items-end self-center flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2"
        type="button"
      >
        Go
      </button>
